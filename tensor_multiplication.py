...
def calculate_output(X, W, b):
    ...
    """
    # Step 1: Calculate the weighted sum of inputs and weights, and add bias
    weighted_sum = calculate_matrix_prod_with_bias(X, W, b)
    
    # Step 2: Apply activation function
    res = calculate_activation(weighted_sum)
    return res